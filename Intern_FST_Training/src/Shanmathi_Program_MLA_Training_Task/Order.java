...
public class Order{
	...
	public static void main(String[] args) {
		List<Order> OrderInfo=new ArrayList<Order>();
	      ...
	      OrderInfo.add(new Order(165,"Sudha",380,"Sept",2009,"Mumbai","Bicuits",6));
	      OrderInfo.add(new Order(137,"Dharun",310,"Apr",2007,"Hyderabad","Biscuits",8));
	      OrderInfo.add(new Order(139,"Suresh",950,"Sept",2006,"Villupuram","Cake",8));
	      OrderInfo.add(new Order(138,"Babu",630,"Apr",2008,"Delhi","Bicuits",3));
